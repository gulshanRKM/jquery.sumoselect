            ...
            s = this.each(function () {
                ...
                !this.sumo &&
                    ...
                    ((this.sumo = {
                        ...
                        SelAll: function () {
                            var t = this;
                            if (!t.is_multi) return;

                            t.selAll = e('<p class="select-all"><span><i></i></span><label></label></p>');
                            t.selAll.find("label")[0].innerText = l.locale[2] || "Select All";
                            t.optDiv.addClass("selall");

                            t.selAll.on("click", function () {
                                var selectableOptions = t.optDiv.find("li.opt:not(.disabled):not(.hidden)");
                                var selectedOptions = selectableOptions.filter(".selected");
                                var allSelected =
                                    selectableOptions.length > 0 &&
                                    selectedOptions.length === selectableOptions.length;

                                t.toggSelAll(!allSelected, 1);
                                t.selAllState();
                                t.setText();
                            });
                        ...
                        Search: function () {
                            ...
                            (t.ftxt = e(
                                '<input type="text" class="search-txt" value="" placeholder="' + l.searchText + '">'
                            ).on("click", function (e) {
                                e.stopPropagation();
                            })),
                                i.append(t.ftxt),
                        ...
                        selAllState: function () {
                            var t = this;
                            if (l.selectAll && t.is_multi && t.selAll) {
                                var sc = 0, vc = 0;

                                t.optDiv.find("li.opt:not(.disabled):not(.hidden)").each(function (i, s) {
                                    if (e(s).hasClass("selected")) sc++;
                                    vc++;
                                });
                                ...
                                if (sc === vc && vc > 0) {
                                    ...
                                    if (l.selectAllPartialCheck) {
                                        t.selAll.addClass("partial");
                                    } else {
                                        t.selAll.removeClass("partial");
                                    }
                                    t.selAll.removeClass("selected");
                                }
                            }
                        },
                        showOpts: function () {
                        ...
                        nav: function (e) {
                            ...
                            if (l.is_opened && s.length) {
                                ...
                                var a = l.ul,
                                    o = a.scrollTop(),
                                    c = s.position().top + o;
                                c >= o + a.height() - s.outerHeight() && a.scrollTop(c - a.height() + s.outerHeight()),
                                    o > c && a.scrollTop(c);
                            } else l.setOnOpen();
                        },
                        ...
                        toggSelAll: function (t, l) {
                            ...
                            i.E.find("option:not(:disabled,:hidden)").each(function (l, i) {
                                ...
                                l ||
                                    (!i.mob && i.selAll && i.selAll.removeClass("partial").toggleClass("selected", !!t),
                                    i.callChange(),
                                    i.setText(),
                                    i.setPstate());
                        },
